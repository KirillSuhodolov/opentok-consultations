...
var OpentokCalls = (function (_EventEmitter) {
  ...
  _createClass(OpentokCalls, [{
    ...
    value: function emitEvent(key, value) {
      opentokCalls.emit(key, value);

      opentokCalls.emit('property-changed', key, value);

      opentokCalls.emit('hash-changed', {
    ...
    key: 'canBePubslished',
    get: function get() {
      return _container2['default'].opentokSession && _container2['default'].isSessionConnected && _container2['default'].sConnectionCreated && !_container2['default'].publisher;
    }
  }, {
    key: 'hasPublisher',
    get: function get() {
