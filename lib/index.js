...
var OpentokCalls = (function (_EventEmitter) {
  ...
  _createClass(OpentokCalls, [{
    ...
    key: 'canBePublished',
    get: function get() {
      return _container2['default'].opentokSession && _container2['default'].isSessionConnected && _container2['default'].isConnectionCreated && !_container2['default'].publisher;
    }
  }, {
    key: 'hasPublisher',
    get: function get() {
